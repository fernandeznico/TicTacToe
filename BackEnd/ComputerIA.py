...
from BackEnd.StaticDataBase import win_sets, center_position, places
...
class ComputerIA:
    ...
    def move(self) -> str:
        ...
        # First wins if is possible, second defends if is needed:
        ...
        print(available_win_sets)
        position_to_take = general_move(available_win_sets, self.positions_taken)
        # Take any:
        available_positions = places - self.positions_taken - self.rival_positions_taken
